...
model_dir = "/home/Public/Megatron-LM/checkpoints/gpt2-117m-emotion"
hf_model_dir = os.path.join(model_dir, "gpt2_117m_hf")
...
class c_args(object):
    def __init__(self):
        ...
        self.world_size = 1
        self.rank = 0
        self.load = "/home/Public/Megatron-LM/checkpoints/gpt2-117m-emotion"
        self.finetune = False
