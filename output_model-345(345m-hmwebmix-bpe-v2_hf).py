...
model_dir = "/home/Public/Megatron-LM/checkpoints/345m-hmwebmix-bpe-v2"
hf_model_dir = os.path.join(model_dir, "345m-hmwebmix-bpe-v2_hf")
...
class c_args(object):
    def __init__(self):
        ...
        self.world_size = 1
        self.rank = 0
        self.load = "/home/Public/Megatron-LM/checkpoints/345m-hmwebmix-bpe-v2"
        self.finetune = False
